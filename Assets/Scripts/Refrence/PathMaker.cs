...
public class PathMaker : MonoBehaviour
{
	...
	int counter = 0;
	float randomFloatOne;
	float randomFloatTwo;
	float tileInt;
	public Transform floorPrefab;
	public Transform pathmakerSpherePrefab;
	public Transform bloodPrefab, normalFloorPrefab, SpiderPrefab, flowerPrefab;
	public static int globalTileCount = 0;
	//public List<GameObject> tileList;
	//public Vector3 tileCoords;
	void Start()
	{
		randomFloatOne = Random.Range(0, .10f);
		Debug.Log("randomIntOne = " + randomFloatOne);
		randomFloatTwo = Random.Range(.11f, .20f);
